...
class MInvoice extends CI_Model
{
    ...
    public function getCodWaitingByCity($id_city)
    {
        $this->db->join('tb_surat_jalan', 'tb_surat_jalan.id_surat_jalan = tb_invoice.id_surat_jalan');
        $this->db->join('tb_contact', 'tb_contact.id_contact = tb_surat_jalan.id_contact');
        $this->db->order_by('id_invoice', 'DESC');
        $query = $this->db->get_where('tb_invoice', ['tb_contact.id_city' => $id_city, 'tb_surat_jalan.is_cod' => 1, 'tb_invoice.status_invoice' => 'waiting', 'total_invoice >' => '1000'])->result_array();
        return $query;
    }
    ...
    public function getByIdContactWaiting($id_contact)
    {
        $this->db->join('tb_surat_jalan', 'tb_surat_jalan.id_surat_jalan = tb_invoice.id_surat_jalan');
        $this->db->join('tb_contact', 'tb_contact.id_contact = tb_surat_jalan.id_contact');
        $this->db->order_by('tb_surat_jalan.id_contact', 'ASC');
        $query = $this->db->get_where('tb_invoice', ['tb_surat_jalan.id_contact' => $id_contact, 'tb_invoice.status_invoice' => 'waiting'])->result_array();
        return $query;
    }

    public function getByIdInvoiceWaiting($id_invoice)
    {
        $this->db->join('tb_surat_jalan', 'tb_surat_jalan.id_surat_jalan = tb_invoice.id_surat_jalan');
        $this->db->join('tb_contact', 'tb_contact.id_contact = tb_surat_jalan.id_contact');
        $this->db->order_by('tb_surat_jalan.id_contact', 'ASC');
        $query = $this->db->get_where('tb_invoice', ['tb_invoice.id_invoice' => $id_invoice, 'tb_invoice.status_invoice' => 'waiting'])->result_array();
        return $query;
    }
    ...
    public function getByIdContactNoMerch($id_contact)
    {
        $this->db->join('tb_surat_jalan', 'tb_surat_jalan.id_surat_jalan = tb_invoice.id_surat_jalan');
        $this->db->join('tb_contact', 'tb_contact.id_contact = tb_surat_jalan.id_contact');
        $this->db->where('YEAR(date_invoice) >', '2023');
        $this->db->order_by('tb_surat_jalan.id_contact', 'ASC');
    ...
    public function getGroupedContactUnpaid($dateFrom = null, $dateTo = null, $id_contact = null, $id_city = null, $id_distributor = null)
    {
        $this->db->join('tb_surat_jalan', 'tb_surat_jalan.id_surat_jalan = tb_invoice.id_surat_jalan');
        $this->db->join('tb_contact', 'tb_contact.id_contact = tb_surat_jalan.id_contact');
        $this->db->join('tb_city', 'tb_contact.id_city = tb_city.id_city');
    ...
    public function getOldestInvoiceByIdContact($id_contact)
    {
        $this->db->join('tb_surat_jalan', 'tb_surat_jalan.id_surat_jalan = tb_invoice.id_surat_jalan');
        $this->db->join('tb_contact', 'tb_contact.id_contact = tb_surat_jalan.id_contact');
        $this->db->join('tb_city', 'tb_contact.id_city = tb_city.id_city');
        $this->db->order_by('tb_invoice.date_invoice', 'ASC');
        $query = $this->db->get_where('tb_invoice', ['tb_contact.id_contact' => $id_contact], 1)->row_array();
        return $query;
    }
    ...
    public function getByIdContactAndMonth($id_contact, $month)
    {
        ...
        $this->db->join('tb_city', 'tb_contact.id_city = tb_city.id_city');
        $this->db->order_by('tb_invoice.date_invoice', 'ASC');
        $query = $this->db->get_where('tb_invoice', ['tb_contact.id_contact' => $id_contact, "DATE_FORMAT(date_invoice, '%Y-%m') =" => $month])->result_array();
        return $query;
    }
