...
class Reportjadwalvisit extends CI_Controller
{
    ...
    public function print()
    {
        ...
        $tambahanVisit = $this->db->join('tb_contact', 'tb_contact.id_contact = tb_visit.id_contact')->where('tb_contact.id_city', $id_city)->where("id_contact NOT IN (SELECT id_contact FROM tb_jadwal_visit WHERE date_jadwal_visit = '$date')", null, true)->where('tb_visit.date_visit', $date)->get('tb_visit')->result_array();
