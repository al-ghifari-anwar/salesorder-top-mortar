        ...
        if ($contact) {
            ...
            if ($city['grouping_kurir'] == 'Not set') {
                ...
                if ($courier) {
                    ...
                    $nama_city_group = trim(preg_replace("/\\d+/", "", $contact['nama_city']));
                    $nama_city_group_fixed = strtok($nama_city_group, " ");

                    $courier = $this->MUser->getCourierByCityGroup($nama_city_group_fixed);
                    $id_courier = $courier['id_user'];
                    // 
                }
            } else {
