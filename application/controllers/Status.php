...
class Status extends CI_Controller
{
    ...
    public function print_rekap()
    {
        ...
        $data['store'] = $this->db->get_where('tb_status_change', ['MONTH(tb_status_change.created_at) ' => $month, 'YEAR(tb_status_change.created_at) ' => date("Y"), 'tb_contact.id_city' => $id_city])->result_array();
