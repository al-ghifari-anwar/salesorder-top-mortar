        ...
        if ($nomorhp == null) {
            ...
            if ($getTukang) {
                if ($getTukang['is_demo'] == 0) {
                    ...
                    if ($getVoucherTukang) {
                        if ($getVoucherTukang['is_claimed'] == 0) {
                        ...
                        // $status = isset($resArray['content']) == 'success';
                        $status = $res['status'];
                        $data = $res['data'][0];
                        ...
                        if ($status == "success") {
                            ...
                            $this->session->set_flashdata('success', "Berhasil verifikasi, silahkan cek QR yang telah kami kirim melalui WhatsApp! Id: ");
                            return redirect('vctukang/self');
                        } else {
                            $this->session->set_flashdata('failed', "Gagal memverifikasi nomor seri, silahkan coba lagi!");
                            return redirect('vctukang/self');
