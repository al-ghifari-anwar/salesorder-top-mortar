...
$route['closing-suratjalan'] = 'SuratJalan/bypassClosing';
...
$route['invoice/print-all/(:num)'] = 'Invoice/printAll/$1';
// Rekap Invoice
...
$route['insert-transit'] = 'Payment/insertTransit';
...
$route['reg-voucher-special/(:num)'] = 'Voucher/regist_voucher_special/$1';
...
$route['badscore/approve/(:num)/(:num)'] = 'Badscore/approve/$1/$2';
$route['badscore/tampilkan/(:num)/(:num)'] = 'Badscore/tampilkan/$1/$2';
// Minimum stok
...
$route['apporder/reject/(:num)'] = 'Apporder/reject/$1';
// Topseller
...
$route['qrsak/file/(:num)'] = 'Qrsak/file/$1';
$route['qrsak/file/delete/(:num)'] = 'Qrsak/deleteFile/$1';
$route['qrsak/create-file'] = 'Qrsak/createFile';
$route['qrsak/insert-value-batch'] = 'Qrsak/insertValueBatch';
$route['qrsak/insert-value'] = 'Qrsak/insertValue';
...
$route['haloai/create-order/new'] = 'Haloai/createOrderNew';
$route['haloai/report-visit'] = 'HaloaiReportVisit/process';
// Send notif jadwal
...
$route['konten/sent'] = 'Kontenmsg/sent';
