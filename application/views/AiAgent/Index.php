                            ...
                            <table id="table" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    foreach ($aiAgents as $aiAgent) : ?>
                                        <?php
                                        $user = $this->MUser->getById($aiAgent['user_updated']);
                                        ?>
                                        <tr>
                                            <td class="text-center"><?= $no++; ?></td>
                                            <td>
                                                <h6 class="font-weight-bold"><?= $aiAgent['name_ai_agent'] ?></h6>
                                            </td>
                                            <td class=""><?= date('d M Y', strtotime($aiAgent['updated_at'])) ?></td>
                                            <td>
                                                <h6 class="font-weight-bold"><?= $user ? $user['full_name'] : '-' ?></h6>
                                            </td>
                                            <td>
                                                <a href="<?= base_url('ai-agent/detail/') . $aiAgent['id_ai_agent'] ?>" class="btn btn-primary" title="Detail"><i class="fas fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
