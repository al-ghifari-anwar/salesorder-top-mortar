                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span>Last Update: <?= date('d M Y', strtotime($aiAgent['updated_at'])) ?></span>
                            <span>Updated By: <?= $user['full_name'] ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-9">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('ai-agent/update/prompt') ?>" method="POST">
                                <div class="form-group">
                                    <textarea id="compose-textarea" class="form-control" style="height: 400px" readonly><?= base64_decode($aiAgent['base64_prompt']) ?></textarea>
                                </div>
                                <!-- <div class="form-group">
