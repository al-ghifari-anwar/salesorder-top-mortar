    ...
    <table>
        ...
        ?>
            <?php foreach ($contacts as $contact) : ?>
                ...
                $getVisit = $this->db->get_where('tb_visit', ['id_contact' => $id_contact, 'DATE(date_visit) >=' => $dateFrom, 'DATE(date_visit) <=' => $dateTo, 'source_visit !=' => 'normal', 'is_approved' => 1])->result_array();
