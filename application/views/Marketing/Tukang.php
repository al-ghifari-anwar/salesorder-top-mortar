    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <?php foreach ($kontens as $marketing) : ?>
                    <div class="col-6 col-md-3 col-lg-3">
                        <!-- small box -->
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <br>
                                <p class="card-text text-secondary"><i><?= $marketing['body_marketing_message'] ?></i></p>
                                <a href="<?= base_url('delete-marketing/') . $marketing['id_marketing_message'] . '/tukang' ?>" class="btn btn-danger">Delete</a>
                                <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal-edit<?= $marketing['id_marketing_message'] ?>">Edit</a>
                            </div>
                        </div>
                    </div>
                    <div class="modal fade" id="modal-edit<?= $marketing['id_marketing_message'] ?>">
