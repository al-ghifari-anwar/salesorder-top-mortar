    ...
    <table class="border">
        ...
        <?php if ($user != null) : ?>
            <?php foreach ($user as $user) : ?>
                ...
                $dateGroup = $this->db->get_where("tb_visit", ['id_user' => $user['id_user']])->result_array();
                ?>
                <tr>
                ...
                <?php foreach ($dateGroup as $dateGroup) : ?>
                    ...
                    $visitByDate = $this->db->get_where('tb_visit', ['DATE(date_visit)' => date("Y-m-d", strtotime($dateGroup['date_visit'])), 'is_deleted' => 0])->result_array();
                    ?>
