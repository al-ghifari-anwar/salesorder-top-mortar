                        ...
                        <div class="card-body">
                            <table id="table" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    foreach ($qrsak_files as $qrsak_file) : ?>
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            <td><?= $qrsak_file['pdf_qrsak_file'] ?></td>
                                            <td><?= $qrsak_file['qty_qrsak_file'] ?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('qrsak/create-file') ?>" method="POST">
                    <input type="hidden" name="id_qrsak" value="<?= $qrsak['id_qrsak'] ?>">
                    <div class="form-group">
                        <label for="">Jumlah Halaman (1 Halaman berisi 48 QR)</label>
                        <input type="number" name="jml_page" class="form-control" value="1">
                    </div>
