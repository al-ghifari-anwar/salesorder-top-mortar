                                ...
                                <tbody>
                                    ...
                                    foreach ($jadwalVisits as $jadwalVisit): ?>
                                        ...
                                        foreach ($seperateJadwals as $seperateJadwal) {
                                            ...
                                            $payment = $this->db->select('SUM(amount_payment) AS amount_payment')->join('tb_invoice', 'tb_invoice.id_invoice = tb_payment.id_invoice')->join('tb_surat_jalan', 'tb_surat_jalan.id_surat_jalan = tb_invoice.id_surat_jalan')->where('DATE(tb_payment.date_payment)', $date)->get('tb_payment')->row_array();

                                            // echo json_encode($payment);
                                            // die;
                                            //->where('tb_surat_jalan.id_contact', $id_contact)
