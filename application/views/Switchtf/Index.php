                                            ...
                                            <td>
                                                <form class="form" action="<?= base_url('switchtf/update/') . $data['id_switch_tf'] ?>" method="post">
                                                    <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                        <input type="checkbox" name="status_switch_tf" onchange="$('.form').submit()" class="custom-control-input" id="customSwitch3<?= $data['id_switch_tf'] ?>" <?= $data['status_switch_tf'] == 1 ? 'checked' : '' ?>>
