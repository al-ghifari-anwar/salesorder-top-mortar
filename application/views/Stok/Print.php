        ...
        <?php if ($masterProduks != null) : ?>
            ...
            foreach ($masterProduks as $masterProduk) : ?>
                ...
                if ($getProdukDatas != null) {
                    ...
                    $getStokOut = $this->db->get_where('tb_detail_surat_jalan', ['tb_detail_surat_jalan.created_at >' => $dateFrom, 'tb_detail_surat_jalan.created_at <' => $dateTo, 'tb_surat_jalan.is_closing' => 1])->row_array();
                } else {
                ...
                if ($getProdukDatasAwal != null) {
                    ...
                    $this->db->select('SUM(qty_produk) AS jml_stokOut');
                    $this->db->where_in('id_produk', $idProduks);
                    $jumlahAwalPengeluaran = $this->db->get_where('tb_detail_surat_jalan', ['tb_detail_surat_jalan.created_at <=' => $dateFrom, 'tb_detail_surat_jalan.created_at >=' => $dateCutoff, 'tb_surat_jalan.is_closing' => 1])->row_array();
                } else {
                ...
                <tr>
                    ...
                    <td class="text-center border-r"><?= $valJumlahAwal ?> (<?= $jumlahAwal['jml_stokAwal'] ?>|<?= $jumlahAwalPengeluaran['jml_stokOut'] ?>)</td>
